...
class Nav2Commander(Node):
    def __init__(self):
        ...
        # 👁️ [눈 1: 긴급 정지용] 물리적 충돌 직전
        self.danger_zone_front = 0.25   
        self.danger_zone_corner = 0.18  
        
        # 👁️👁️ [눈 2: FSM 우회 알림용] 복도 벽을 오해하지 않도록 시야 폭/길이 축소
        ...
        self.get_logger().info('🗺️ Nav2 커맨더 가동 (벽면 오인 방지 및 실시간 알람 복구 완료)')
    ...
    def scan_callback(self, msg):
        ...
        for i, r in enumerate(msg.ranges):
            ...
            # [눈 2] 우회 알림용 넓은 시야 (±40도) - 60도에서 40도로 좁혀서 옆 벽면 무시
